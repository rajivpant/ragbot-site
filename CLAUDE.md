# Claude Code Context: ragbot-site

## Repository: ragbot-site (PUBLIC)

This is a **PUBLIC** repository containing the informational website for Ragbot.
...
- Informational website for Ragbot at ragbot.ai
...
```bash
cd ~/projects/my-projects/ragbot-site
```
